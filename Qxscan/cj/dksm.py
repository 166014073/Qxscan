...
duankou = {"20":"ftp-data","21":"ftp服务[允许匿名的上传、下载、爆破和嗅探操作]","22":"ssh远程连接[爆破、SSH隧道及内网代理转发、文件传输]","23":"telnet远程连接[爆破、嗅探、弱口令]","25":"smtp邮件服务[用户名枚举、邮件伪造]",
			"53":"dns域名系统[允许区域传送、DNS劫持、缓存投毒、欺骗]","80":"http协议","81":"hosts2-ns","135":"msrpc","8080":"http协议",
			...
			"69":"TFTP服务[允许匿名的上传、下载、爆破和嗅探操作]","2049":"NFS服务[配置不当]","389":"LDAP目录访问协议[注入、允许匿名访问、弱口令]","5900":"VNC[弱口令爆破]",
			'5632':'PcAnywhere服务[抓取密码、代码执行]','7001':'WebLogic控制台[Java反序列化、弱口令]','7002':'WebLogic控制台[Java反序列化、弱口令]','8089':'http','9090':'WebSphere控制台[java反序列化、弱口令]',
			...
			'110':'POP3协议[爆破、嗅探]','143':'IMAP协议[爆破]','67':'DHCP服务[劫持、欺骗]','68':'DHCP未授权访问服务[劫持、欺骗]','161':'S[]NMP协议[爆破、收集目标内网信息]',
			'2181':'ZooKeeper服务[未授权访问]','8069':'Zabbix服务[远程执行、SQL注入]','9200':'Elasticsearch服务[远程执行]',
